...
FROM
 ...
 select quantity, count(order_details_id) as size_order
 from order_details 
 group by quantity;
 ...
 -- List  the top 5 most orderd pizza types 
...
-- Join the necessary tables to find the total of each pizza category ordered.
...
FROM
 ...
 -- Analyeze the cumulative revenue generated over time.
